...
(function (sandbox) {
    ...
    // Load libraries here so they aren't instrumented.
    const config = { stopifyArray: a => a },
          lib220 = require('../../../../../libs/lib220.js')(config),
          oracle = require('../../../../../libs/oracle.js')(config),
          rrt = require('../../../../../libs/rrt.js')(config);

    // Expose EJS custom globals.
    global.lib220 = Object.freeze(lib220);
    global.hire = oracle.hire;
    global.wheat1 = oracle.wheat1;
    global.chaff1 = oracle.chaff1;
    global.geometry = Object.freeze({
        Point: rrt.newPoint,
        Line: rrt.newLine,
        intersects: rrt.intersects
    });
    global.test = () => {};
